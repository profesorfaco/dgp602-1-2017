...
;?>
<p><strong>Diseño dispone de <?php echo $all;?> académicos</strong> (los cuales dedican <?php echo round ($horas/$all);?> horas en promedio semanales) <?php echo $ordinaria;?> de ellos están en la Categoría Académica Ordinaria, <?php echo $docente;?> están en la Categoría Académica Docente, y <?php echo $adjunta;?> están en la Categoría Académica Adjunta.</p>
<?php
$full_time = 0;
for ($b = 0; $b < $all; $b++) {
