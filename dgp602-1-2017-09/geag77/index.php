...
<p>Profesores que han demostrado una actividad docente sostenida, realizándola en forma autónoma y creativa, con pleno dominio de su especialidad, dando a conocer su experiencia en textos de uso docente:</p>
<ol>
<?php
for ($d = 0; $d < $all; $d++) {
  if((($datos[$d]['Grado']) == "Magister") && ($datos[$d]['Horas'])){
    echo '<li>'.strstr($datos[$d]["Nombres"], ' ', true).' '.$datos[$d]["Apellidos"],' ('.$datos[$d]["Horas"].')</li>';
  }
};?>
</ol>
<p>En promedio los profesores de Diseño de la Facultad de Arquitectura y Urbanismo realizan un promedio de <strong>24 horas semanales</strong> dedicadas a las actividades de Diseño.</p>
