...
<p>A continuación se muestra el listado de profesores y la cantidad de horas que dedican a la universidad </p>
<ol>
<?php
for ($d = 0; $d < $all; $d++) {
...
<p>El promedio de horas dedicadas a la Universidad de Chile son <strong> </strong></p>
<ol>
  <ol>
  <h3><?php print_r($horas/$all)
  ;?> horas.</h3>
  </ol>
